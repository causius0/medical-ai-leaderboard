#!/usr/bin/env python3
"""
Custom script to run Qwen evaluation on text-only questions in batches.
"""
...
def main():
    print("="*70)
    print("Qwen Evaluation on Text-Only Questions (Batched)")
    print("="*70)
    ...
    output_path = output_dir / f"qwen_text_only_batched_{timestamp}.json"
