#!/usr/bin/env python3
"""
Custom script to run Liquid LFM-2 24B evaluation on text-only questions in batches.
"""
...
def main():
    print("="*70)
    print("Liquid LFM-2 24B Evaluation on Text-Only Questions (Batched)")
    print("="*70)
    ...
    model_id = "liquid/lfm-2-24b-a2b"  # Liquid AI model on OpenRouter
    model_name = "Liquid LFM-2 24B"
    temperature = 0.7
    batch_size = 50  # Same as Gemma for consistency
    ...
    output_path = output_dir / f"liquid_text_only_batched_{timestamp}.json"
